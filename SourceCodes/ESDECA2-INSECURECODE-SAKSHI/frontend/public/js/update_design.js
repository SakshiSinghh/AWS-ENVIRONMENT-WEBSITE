...
if ($updateDesignFormContainer.length != 0) {
    ...
    $('#submitButton').on('click', function(event) {
        ...
        axios({
                method: 'put',
                url: 'https://uide6ygynd.execute-api.us-east-1.amazonaws.com/test?fid=' + fileId + '&designTitle=' + designTitle + '&designDescription=' + designDescription,          
                data: webFormData,
    ...
    function getOneData() {
        ...
        axios({
                ...
                method: 'get',
                timeout: 5000,
                url: 'https://uide6ygynd.execute-api.us-east-1.amazonaws.com/test?fid=' + fileId,
            })
            .then(function(response) {
